...
// * Swapping FN and RSh, seeing how that feels, rearranging arrow and media keys
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_directional(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_RALT, KC_RSFT, KC_LEFT, KC_DOWN, KC_RIGHT
  ),
  ...
  LAYOUT_directional(
    ...
    ______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, ______, ______, ______,  ______, KC_UP, ______, ______, ______, RESET,
    ______, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, ______, ______, ______, KC_LEFT, KC_DOWN, KC_RIGHT, ______,
