...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_directional(
    ...
    ______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, ______, ______, ______,  KC_UP, ______, ______, ______, ______, RESET,
    ______, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, ______, ______, KC_LEFT, KC_DOWN, KC_RIGHT, ______, KC_GRV, ______,
    ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_MSTP, KC_MPLY, KC_VOLU, ______,
