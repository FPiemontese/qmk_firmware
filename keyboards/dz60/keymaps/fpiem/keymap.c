...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------------------------------------+
   * |           |RGB T|RGB M|Hue ±|Sat ±|Val ±|     |     |     |     |STOP |PAUSE |VOLU |    |
   * |-----------------------------------------------------------------------------------------+
   * |      |       |       |                                   |     |      |TRKBW|VOLD |TRKFW|
   * `-----------------------------------------------------------------------------------------'
   */
  ...
  LAYOUT_directional(
    ...
    KC_CAPS, KC_LEFT, KC_DOWN, KC_RIGHT, ______, ______, ______, KC_LEFT, KC_DOWN, KC_RIGHT, ______, KC_GRV, ______,
    ______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, ______, KC_MS_BTN2, TD(TD_HOME_PAGEUP), TD(TD_END_PAGEDOWN), KC_MSTP, KC_MPLY, KC_VOLU, ______,
